...
<<<<<<< HEAD
        ...
        <div class="span4 well" style="width: 330px">
          <h1 style="margin-bottom: 10px;"><a href="<?php Links::render("recipes") ?>">Recipes</a></h1>
          ...
          <p><a class="btn btn-primary btn-large" href="<?php Links::render("recipes") ?>">Recipes &raquo;</a></p>
        </div>
        <div class="span4 well" style="width: 330px">
