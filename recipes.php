    ...
    <div class="container">
	  ...
	  <div class="row">
   	  	<div class="span12 well">
      		<a href="/add-recipe" class="btn btn-primary btn-large"><i class="icon-plus-sign icon-white"></i> Add Recipe</a>
      	</div>
      </div>
      ...
      <div class="row">
		<div class="span12 well">
		      ...
		      <div id="no-recipes" class="alert alert-grey no-bottom-margin" <?php if(count($recipes) > 0): ?>style="display: none;"<?php endif; ?>>
		      	No recipes added. <a href="/add-recipe">Add</a> a recipe now.
			  </div>
				      	...
				      	<tbody>
			      			<?php foreach($recipes as $recipe): ?>	
			      				<tr id="<?= $recipe->id ?>" class="recipe">
				      				...
				      				<td><a href="/view-recipe/<?= $recipe->id ?>"><?= $recipe->name ?></a></td>
